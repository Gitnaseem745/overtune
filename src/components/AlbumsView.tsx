        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 gap-5">
          {filteredAlbums.map((album) => (
            <div
              ...
              className={`group cursor-pointer p-3.5 rounded-2xl border transition-all duration-200 transform hover:-translate-y-1 ${
                isDark
            ...
            >
              <div className="relative mb-3 rounded-xl overflow-hidden aspect-square shadow-sm bg-neutral-800">
                ...
                <div
                  ...
                  className={`absolute right-2.5 bottom-2.5 w-11 h-11 rounded-full flex items-center justify-center shadow-lg opacity-0 group-hover:opacity-100 transform translate-y-2 group-hover:translate-y-0 transition-all duration-200 ${
                    isDark ? 'bg-[#1db954] text-black hover:scale-105' : 'bg-[#f9a826] text-white hover:scale-105'
                  }`}
                  title="Play Album"
                >
